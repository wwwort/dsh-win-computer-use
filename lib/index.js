...
const STEP_ITEM = {
    ...
    properties: {
        ...
        ref: { type: 'string', description: 'Handle to an element remembered by an earlier find step (`as`).' },
        ...
        state: { type: 'string', enum: ['exists', 'gone', 'foreground', 'visible'], description: 'wait only, default exists.' },
