...
const STEP_ITEM = {
  ...
  properties: {
    ...
    state: { type: 'string' as const, enum: ['exists', 'gone', 'foreground', 'visible', 'text_stable'], description: 'wait only, default exists. text_stable = return once the window text stops changing (and return it as text) -- use it to wait for a reply instead of guessing a sleep.' },
